...
# 4. Downlinkレスポンスを待ち受ける
# 5. Downlinkレスポンスを評価する (エラーの場合は、error_notification.pyの関数を使用してエラー通知をデコードし、JSONを標準出力して処理を終了する）
# 6. 対象のアップリンク通知を待ち受ける
# 7. アップリンク通知のセンサー情報を評価する
# 8. アップリンク通知をデコードする
# 9. アップリンク通知のdataclassをJSON形式に変換する
# 10. JSON形式のアップリンク通知を標準出力に出力する
# 11. シリアル通信(モニタリング)を停止する
